...
eks_instance_types         = ["t3.large"] # Larger instances for production
eks_desired_size           = 3
eks_max_size               = 10
eks_min_size               = 2
...
# -------- ALB Configuration ----------
alb_name               = "alb"
enable_https           = false # Disabled for production without valid certificate
enable_alb_access_logs = true
alb_log_bucket_name    = "alb-logs-fintech-prod"

# -------- DNS Configuration ----------
# For production, we'll use a self-signed certificate or disable HTTPS
